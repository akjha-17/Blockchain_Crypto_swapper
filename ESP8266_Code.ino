...
namespace {
const char* SSID          =  "aman_crypto";    // Change this to your WiFi name
const char* PASSWORD      =  "chicken123";    // Change this to your WiFi password
const char* USERNAME      =  "aravind_a";// Change this to your Duino-Coin username
const char* RIG_IDENTIFIER = "arra36";         // Change this if you want a custom miner name (or use Auto to autogenerate)
