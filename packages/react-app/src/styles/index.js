const styles = {
  ...
  headTitle: "text-lilgreen font-poppins font-black text-5xl tracking-wide",
  ...
  exchange:
    "w-full min-h-[400px] bg-site-lilgreen backdrop-blur-[4px] rounded-3xl shadow-card flex p-10",
  ...
  amountInput:
    "w-full flex-1 bg-transparent outline-none font-poppins font-black text-2xl text-bgreen",
  currencyButton:
    "flex flex-row items-center bg-site-dim2 py-2 px-4 rounded-xl font-poppins font-bold text-bgreen",
  currencyList:
    "absolute z-10 right-0 bg-site-white border-[1px] border-site-dim2 w-full mt-2 rounded-lg min-w-[170px] overflow-hidden",
  currencyListItem:
  ...
  // WalletButton
  walletButton:
    "bg-site-bgreen border-none outline-none px-6 py-2 font-poppins font-bold text-lg text-white rounded-3xl leading-[24px] hover:bg-pink-600 transition-all",

  // loader
  loader: "flex justify-center items-center flex-col w-full min-h-full",
  loaderImg: "w-56 h-56 object-contain",
  loaderText:
    "font-poppins font-normal text-dim-bgreen text-lg text-center mt-10",

  // balance
  balance: "w-full text-left mt-2 ml-2",
  balanceText: "font-poppins font-normal text-dim-bgreen",
  balanceBold: "font-semibold text-bgreen",
};
